...
def formSubmit():
    ...
    querystring = {"location":coordinates, "fields":["temperature","temperatureApparent","temperatureMin","temperatureMax","windSpeed","windDirection","humidity","pressureSeaLevel","uvIndex","weatherCode","precipitationProbability","precipitationType","sunriseTime","sunsetTime","visibility","moonPhase","cloudCover"],"units":"imperial","timesteps":["current","1d","1h"],"timezone":"America/Los_Angeles","apikey":"R2cChkU3mSRBSiseul2jBg1H3sRmImRt"} #R2cChkU3mSRBSiseul2jBg1H3sRmImRt
    ...
    weatherCodeDescriptionImageMapping = {
        ...
        "3000": ('Light Wind','static/images/light_wind.svg'),
        "3001": ('Wind','static/images/wind.svg'),
        "3002": ('Strong Wind','static/images/strong_wind.svg'),
